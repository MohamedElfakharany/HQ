...
class VerificationChangeMobileScreen extends StatefulWidget {
  VerificationChangeMobileScreen({
    Key? key,
  ...
  @override
  State<VerificationChangeMobileScreen> createState() =>
      _VerificationChangeMobileScreenState();
}

class _VerificationChangeMobileScreenState
    extends State<VerificationChangeMobileScreen> {
  ...
  void signInWithPhoneAuthCredential(
    ...
    try {
      ...
      if (authCredential.user != null) {
        AppCubit.get(context).changeNumber(phoneCode: widget.phoneCode,phone: widget.mobileNumber);
      }
            ...
            child: ConditionalBuilder(
              ...
              builder: (context) => ListView(
                children: [
                  ...
                  verticalMediumSpace,
                  ConditionalBuilder(
                    condition: state is! AppChangeNumberLoadingState,
