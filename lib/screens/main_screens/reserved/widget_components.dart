...
class ReservedCard extends StatelessWidget {
  ReservedCard({Key? key, this.labReservationsDataModel, this.homeReservationsDataModel}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state){
        if(labReservationsDataModel?.tests?.isEmpty ?? homeReservationsDataModel!.tests!.isEmpty){
          title = labReservationsDataModel?.offers?.first.title ?? homeReservationsDataModel!.offers?.first.title;
        }else if (labReservationsDataModel?.offers?.isEmpty ?? homeReservationsDataModel!.offers!.isEmpty){
          title = labReservationsDataModel?.tests?.first.title ?? homeReservationsDataModel!.tests?.first.title;
        }else {
          title = '';
        }
        return SizedBox(
